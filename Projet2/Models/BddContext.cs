...
namespace Projet2.Models
{
    public class BddContext : DbContext
    {
        ...
        public void InitialiseDb()
        {
            ...
            Activite activite3 = new Activite() { Id = 3, SortieAdherentId = 1, NomActivite = "Vol du soir", DateDebutActivite = new DateTime(2023,05,18), DateFinActivite = new DateTime(2023,05,28), DescriptionActivite = "Vols de restitution thermique", LieuActivite = "Bordeaux", NombrePlaceActivite = 5, TypeActivite = "SortieAdherent", ClubId = 6, SortieAdherent = sortieAdherentVolSoir };
