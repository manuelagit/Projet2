...
namespace Projet2.Models
{
    public class BddContext : DbContext
    {
        ...
        public void InitialiseDb()
        {
            ...
            Adresse adresse = new Adresse() { Id = 1, CodePostal = 75014, NomVille = "PARIS", NomRue = "rue Pigeon", NumeroRue = 48 };
            ...
            Activite activite2 = new Activite() { Id = 2, EvenementClubId = 2, NomActivite = "Voyage Slovénie", DateDebutActivite = new DateTime(2023 / 03 / 18), DateFinActivite = new DateTime(2023 / 03 / 18), DescriptionActivite = "Stage cross", LieuActivite = "Slovénie", NombrePlaceActivite = 20, TypeActivite = "EvenementClub", ClubId = 6, EvenementClub = evenement2 };
